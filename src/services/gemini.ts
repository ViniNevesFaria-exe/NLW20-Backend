...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    INSTRUÇÕES:
    - Use apenas informações contidas no contexto enviadp;
    - Se a resposata não for encontrada no contexto, apenas responda que não possui informações suficientes para responder;
    - Seja objetivo;
    - Mantenha um tom educativo e profissional;
    - Cite trechos relevantes do contexto se apropriado;
    - Se for citar o contexsto, utilize o termo "conteúdo da aula";
  `.trim();
